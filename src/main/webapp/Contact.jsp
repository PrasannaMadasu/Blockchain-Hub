...
<div class="contact-section">
    ...
    <div>
        ...
        <div class="contact-details">
            <p><strong>Email:</strong> blockchainhub@university.edu</p>
            <p><strong>Phone:</strong> +123 456 7890</p>
            <p><strong>Address:</strong> 123 Blockchain Lane, Crypto City, Country</p>
        </div>
        <br>   
        <br>                                          
         <div style="display: flex; justify-content: center; align-items: center; gap: 15px; padding-bottom: 10px;">
              ...
              <a href="https://www.instagram.com/klu_tbh/"><img src="images/instagram icon.png"  width="45"></a>
        </div>
    </div>
</div>
